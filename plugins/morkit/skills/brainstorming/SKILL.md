...
6. **Write design doc** — save to `morkit/output/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `morkit/output/specs/YYYY-MM-DD-<topic>-design.md`
