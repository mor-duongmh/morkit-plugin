...
1. **Create Failing Test Case**
   ...
   - Use the `morkit:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **morkit:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **morkit:verification-before-completion** - Verify fix worked before claiming success
