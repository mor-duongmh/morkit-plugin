...
Available command names (as of v1.x): `propose`, `review`, `archive`, `brainstorming`, `write-plan`, `execute-plan`, `deep-review`, `deep-review-doctor`, `deep-review-post`, `init`, `docs`, `scout`.
