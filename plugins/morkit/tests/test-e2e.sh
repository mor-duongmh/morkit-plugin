...
run_e2e() {
    ...
    assert_dir_exists "morkit/changes/add-csv-export" "e2e: scaffold ok"
    ...
    cat > morkit/changes/add-csv-export/review-checklist.md <<'EOF'
# Review Checklist
- [ ] Items
...
EOF
    ...
    cat > morkit/changes/add-csv-export/tasks.md <<'EOF'
# add-csv-export
...
EOF
    ...
    bash "$VALIDATE" morkit/changes/add-csv-export/tasks.md >/dev/null 2>&1
    ...
    sed -i.bak 's/Overall Decision: PENDING/Overall Decision: OK/' \
        morkit/changes/add-csv-export/review-checklist.md
    rm -f morkit/changes/add-csv-export/review-checklist.md.bak
    ...
    mv morkit/changes/add-csv-export morkit/changes/archive/add-csv-export
    assert_dir_exists "morkit/changes/archive/add-csv-export" "e2e: archived"
    assert_dir_not_exists "morkit/changes/add-csv-export" "e2e: active gone"
    ...
    assert_dir_exists "morkit/changes/legacy" "e2e: migration succeeded"
