...
At session end, the skill auto-saves a design log to `morkit/output/design-logs/YYYY-MM-DD-<topic>-design.md` (5 sections: problem framing · approaches considered · decisions · open questions · next step).
