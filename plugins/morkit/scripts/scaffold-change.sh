...
#
# Output: writes to ${MORKIT_ROOT:-morkit/changes}/<name>/{proposal,design,tasks}.md
...
Creates a new spec change folder under ${MORKIT_ROOT:-morkit/changes}/<name>/
...
Env:
  MORKIT_ROOT          Override the changes folder (default: morkit/changes)
